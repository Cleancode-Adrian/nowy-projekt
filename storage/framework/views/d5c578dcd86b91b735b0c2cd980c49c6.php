        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    <li><a href="<?php echo e(route('announcements.index')); ?>" class="hover:text-white transition-colors">Ogłoszenia</a></li>
                    <li><a href="<?php echo e(route('search.advanced')); ?>" class="hover:text-white transition-colors">Szukaj projektów</a></li>
                    <li><a href="<?php echo e(route('leaderboard')); ?>" class="hover:text-white transition-colors">Ranking</a></li>
                    <li><a href="<?php echo e(route('faq')); ?>" class="hover:text-white transition-colors">FAQ</a></li>
                </ul>
            </div>
...
<?php /**PATH D:\nowy projekt\backend\resources\views/components/footer.blade.php ENDPATH**/ ?>